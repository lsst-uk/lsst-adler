...
def run_adler_day(ssobject_list):
    ...
    for ssoid in ssobject_list:
        ...
        planetoid = AdlerPlanetoid.construct_from_cassandra(ssoid, date_range = [60290., 61902]) 
        ...
        for filt in planetoid.filter_list:
            ...
            if np.isnan(H) or np.isnan(G):
                print("No H and/or phase parameter value found for this object and filter in SSObject or Adler databases.")
...
if __name__ == "__main__":
    ...
    ssobject_list = ['685835657114313227',
                     '-6411717652251119994',
                     '3881603647193383121',
                     '6711448832195578320',
                     '2959207197656523004',
